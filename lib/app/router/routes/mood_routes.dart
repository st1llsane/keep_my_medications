...
import 'package:keep_my_notes/features/mood/presentation/pages/mood_page.dart';
...
final ShellRoute moodRoutes = ShellRoute(
  pageBuilder: (context, state, navigator) => AdaptivePage(
    name: AppRoutes.moodOutlet.name,
    child: MoodPage(navigator: navigator),
  ),
  routes: [
    GoRoute(
